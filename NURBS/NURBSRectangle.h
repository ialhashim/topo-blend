...
public:
	...
	typedef std::vector< std::vector<Real> > Array2D_Real;
    ...
    virtual Vector3 P (Real u, Real v) const;
    virtual Vector3 PU (Real u, Real v) const;
    virtual Vector3 PV (Real u, Real v) const;
    virtual Vector3 PUU (Real u, Real v) const;
    virtual Vector3 PUV (Real u, Real v) const;
    virtual Vector3 PVV (Real u, Real v) const;
